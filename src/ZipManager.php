<?php namespace GiveMeLib\Zip;

use \GiveMeLib\Zip\Zip;
use \Exception;
...
class ZipManager {
     ...
     *
     * @param   \GiveMeLib\Zip\Zip  $zip
     *
     * @return  \GiveMeLib\Zip\ZipManager
     */
    public function addZip(\GiveMeLib\Zip\Zip $zip) {
     ...
     * @return  \GiveMeLib\Zip\ZipManager
     */
    public function removeZip(\GiveMeLib\Zip\Zip $zip) {
